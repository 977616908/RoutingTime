...
//              addOrModifyDetails?resId =20&story=写下这一天的故事&username=18500646286
                NSDictionary *param=@{@"resId":[self.dataObject rtId],
                                      @"story":content,
                                      @"username":userPhone};
               [self initPostWithURL:ROUTINGTIMEURL path:@"addOrModifyDetails" paras:param mark:@"add" autoRequest:YES];
            }
        }else{
            ...
            [self initPostWithURL:ROUTINGTIMEURL path:@"addOrModifyDetails" paras:param mark:@"make" autoRequest:YES];
        }
